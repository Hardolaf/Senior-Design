...
void USCI_I2C::Write(unsigned char slave_address,
  ...
  }  // waiting for slaver address was transferred
...
void USCI_I2C::WriteMultiBytes(unsigned char slave_address,
                               unsigned char register_address,
...
unsigned char USCI_I2C::Read(unsigned char slave_address,
                             unsigned char register_address) {
  // the following code may need modification for use with the MSP432
